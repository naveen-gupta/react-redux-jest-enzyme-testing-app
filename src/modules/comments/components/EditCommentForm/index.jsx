...
const EditCommentForm = (props) => {
  ...
  return (
    <Box between={2}>
      <Input label="Name" value={currentComment ? currentComment.name : ''} disabled />
      <Input label="Title" value={currentComment ? currentComment.title : ''} disabled />
      <TextArea
        label="Comment"
        ...
        error={error && error.hasOwnProperty('comment') ? <React.Fragment>Please provide the comment.</React.Fragment> : ''}
      />
